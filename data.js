...
for(i=0;i<10;i++){
    var a1=document.getElementById("id"+i);
    var b1=products[i]["id"];
    a1.innerHTML="ID: "+b1;

    var a2=document.getElementById("title"+i);
    var b2=products[i]["title"];
    a2.innerHTML="TITLE: "+b2;

    
    var a3=document.getElementById("description"+i);
    var b3=products[i]["description"];
    a3.innerHTML="DESCRIPTION: "+b3;

    var a4=document.getElementById("price"+i);
    var b4=products[i]["price"];
    a4.innerHTML="PRICE: "+b4;

    var a5=document.getElementById("rating"+i);
    var b5=products[i]["rating"];
    a5.innerHTML="RATING: "+b5;

    var a6=document.getElementById("img"+i);
    var b6=products[i]["images"][0];
    a6.src=b6;
    
}

var a=document.getElementById("search");
var c=document.querySelector('#search').value;
console.log(c)
...
//     var count=0;
//     if(products[i]["title"]==document.querySelector('input').value){
//     var a1=document.getElementById("idd"+count);
//     var b1=products[i]["id"];
//     a1.innerHTML="ID: "+b1;

//     var a2=document.getElementById("titlee"+count);
//     var b2=products[i]["title"];
//     a2.innerHTML="TITLE: "+b2;

    
//     var a3=document.getElementById("descriptionn"+count);
//     var b3=products[i]["description"];
//     a3.innerHTML="DESCRIPTION: "+b3;

//     var a4=document.getElementById("pricee"+count);
//     var b4=products[i]["price"];
//     a4.innerHTML="PRICE: "+b4;

//     var a5=document.getElementById("ratingg"+count);
//     var b5=products[i]["rating"];
//     a5.innerHTML="RATING: "+b5;

//     var a6=document.getElementById("imgg"+count);
//     var b6=products[i]["images"][0];
//     a6.src=b6;
//     count++;
// }
